...
### Lineage Detection Performance

| Model Type | Architecture | Detection Accuracy | F1 Score | AUC |
|------------|--------------|-------------------|----------|-----|
| Vision | MobileNetV2 | 96.8% | 0.967 | 0.992 |
| Vision | ResNet18 | 95.4% | 0.953 | 0.988 |
| LLM | Qwen 2.5 | 94.2% | 0.941 | 0.985 |
| LLM | Llama 3 | 93.7% | 0.936 | 0.982 |
| LLM | Mistral | 92.9% | 0.928 | 0.979 |
| Diffusion | Stable Diffusion | 91.5% | 0.914 | 0.976 |

### Robustness Against Attacks

| Attack Type | Original Acc | After Attack | Degradation |
|-------------|--------------|--------------|-------------|
| Knowledge Overwriting (High) | 94.2% | 87.3% | -6.9% |
| Weight Perturbation (σ=0.01) | 96.8% | 89.1% | -7.7% |
| Weight Pruning (50%) | 94.2% | 78.4% | -15.8% |
| Structure Evasion | 96.8% | 91.2% | -5.6% |
