...
from dogs import *
import argparse
from szykm_C_Flowers import get_p_names
# from  load_models import  dimdict
...
def get_data(args, loader, model, spidx):
    ...
    for class_idx in range(n_class):
        l = x_list[class_idx]  # 获取当前类别的样本列表
        l_subset = l
    ...
    #         sum_d = torch.tensor(0.).to(args.device)
...
class Parser:
    ...
    def set_arguments(self):
        ...
        ###############################################
        self.parser.add_argument('--num_class', type=int, default=dimdict['Dogs_c'])
...
if __name__ == "__main__":
    ...
    for parentname in parentmodels:
        ...
        torch.save(dict0, os.path.join('./NON_Dogs_adv', parentname))