...
def get_black_vulnerabilty(args, loader, model):
    ...
    adv_list = torch.zeros(args.num_samples, 3, 64, 64, device=args.device)
...
if __name__ == "__main__":
    ...
    # D:\项目\SZY\pythonProject1\MIATB\SZY2025\modelscls5
    model_paths="D:\项目\SZY\pythonProject1\MIATB\SZY2025\modelscls5/childs/"
